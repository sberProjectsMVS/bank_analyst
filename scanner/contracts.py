...
FIELD_MARKERS = {
    "vtb_privilege_2": {
        ...
        "auto": ("Помощь на дорогах",),
        "concierge": ("консьерж",),
        "sport_beauty_option": ("appoint",),
        "other_benefits": ("ON·PACK",),
    },
    "vtb_privilege_3": {
        ...
        "auto": ("Помощь на дорогах",),
        "concierge": ("консьерж",),
        "sport_beauty_option": ("5 тыс баллов", "appoint"),
        "other_benefits": ("ON·PACK",),
    },
    "vtb_privilege_4": {
        ...
        "concierge": ("консьерж",),
        "sport_beauty_option": ("5 тыс баллов", "appoint"),
        "health_option": ("Телемедицина", "Доктис"),
        "other_benefits": ("ON·PACK",),
    },
    "vtb_prime_5": {
        ...
        "auto": ("Помощь на дорогах",),
        "concierge": ("консьерж",),
        "sport_beauty_option": ("appoint", "Фитмост"),
        "other_benefits": ("ON·PACK",),
    },
    "vtb_prime_6": {
        ...
        "auto": ("Помощь на дорогах",),
        "concierge": ("консьерж",),
        "sport_beauty_option": ("Фитмост", "10 тыс баллов", "appoint"),
        "health_option": ("Телемедицина", "Доктис"),
        "other_benefits": ("ON·PACK",),
    },
    "vtb_prime_7": {
    ...
    "vtb_prime_8": {
        ...
        "concierge": ("консьерж",),
        "sport_beauty_option": ("Фитмост", "10 тыс баллов", "appoint"),
        "health_option": ("Телемедицина", "Доктис", "Медицинское обследование"),
        "other_benefits": ("ON·PACK",),
    },
    "sber_first_4": {
